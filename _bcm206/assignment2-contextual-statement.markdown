...
- The chassis felt mechanically simplistic ("bareboned")
...
In the past, learning about game development meant relying on instructions from experts, most frequently through tutorials written by professionals, while newcomers simply followed along. Yet, today's networked society works differently. Key differences being that knowledge can be spread out, shared among many people, rather than having just one central authority in charge. This idea became obvious in my project during version 10, when a friend studying media mentioned object-oriented design (OOD) from his coursework. Just chatting about it was enough for me to completely change how the project's structure worked.
...
Another important lesson from this process was working with AI as part of the team. Instead of waiting for others to tell me what I could do, I questioned things out for myself, experimenting by giving it specific challenges. Each new version of the raycast vehicle taught me something about what AI could handle and where human guidance was needed. Rather than being shown how AI should be used, I learned by doing and sharing those results with my peers. In this way, collaborative learning, even involving AI, helped us all move forward more quickly and effectively.

## **Learning Moment 2:** Collaborative Refinement and Collective Intelligence

Perhaps Wikipedia is a great demonstration of how today’s network society works. Thousands of people contribute their ideas and corrections, rather than letting one single expert handle all the editing. My project reflected this exact approach, where participants has actual influence. From version 7 through 10, no-one involved fully understood everything about vehicle physics, code design, and user experience. Yet, small pieces of feedback from everyone helped finish the artefact through shared input, not a single guidebook.
...
The Raycast Vehicle Chassis shows how learning and development can happen more openly and collaboratively. Instead of relying on static tutorials from one expert, developers and players help shape the project together by giving feedback, testing, and sharing ideas. We can learn that progress is driven by these everyday interactions, not just by top-down approval. Completing the chassis with realistic physics, a solid code structure, and making it open for everyone in limited timespan highlights how working together proves itself faster and more productive than traditional, expert-driven approaches under the context of today's online network. With new technology gradually phasing itself to the public, there is perhaps much more to anticipate for in the coming future.